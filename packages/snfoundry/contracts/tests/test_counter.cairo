...
fn test_contract_initialization() {
    ...
    assert!(current_counter == expected_counter, "Counter not initialized");
}
...
fn test_increase_counter() {
    ...
    assert!(current_counter == init_counter + 1, "Counter not increased");
...
fn test_decrease_counter_happy_path() {
    ...
    assert!(current_counter == init_counter - 1, "Counter not decreased");
...
fn test_set_counter_owner() {
    ...
    assert!(dispatcher.get_counter() == new_counter, "The owner is unable to set counter");
